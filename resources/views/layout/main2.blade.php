	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	<li class="nav-item"><a class="nav-link {{ Route::currentRouteName() == 'site.index' ? 'active' : '' }}" href="{{route('site.index')}}">Home</a></li>
	          ...
	          <li class="nav-item"><a class="nav-link {{ Route::currentRouteName() == 'site.contatos2' ? 'active' : '' }}" href="{{route('site.contatos2')}}">Entre em contato conosco</a></li>
          </ul>
	      </div>
	    </div>
	  </nav>
